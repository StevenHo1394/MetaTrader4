...
while True:
 try:
    ...
    fx_pairs='XAGUSD' #fx_pairs='XAUUSD'
    ...
    while counter1>0:
        ...
        client = oandapyV20.API(access_token='b1820d124857b58655e36eaa7f856b50-f9269344d4a6e789a9ce102df15af97d',#insert new access token, will be expired
        ...
        print(klines.tail(5))
        if os.name == 'nt':
            klines.to_csv((path+'WinPython\\Forex OHLC\\'+string+'.csv')) #if using windows do not change
        else:
